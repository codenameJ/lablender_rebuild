...
<div id="app" v-if="curuser">
    <v-toolbar dark tabs flat style="background-image: linear-gradient(to right, #2ad4d9, #2ad4a9;" height="100">
        <v-toolbar-title>
            <v-list-item>
                <v-img class="m-2" src="/img/icon.png" max-width="50" max-height="50">
                </v-img>
        ...
        <template v-slot:extension>
            <v-tabs background-color="transparent" v-model="tabs" v-if="type == 'admin'" align-with-title>
                <v-tab style="text-decoration : none;" to="/home">Dashboard</v-tab>
                <v-tab style="text-decoration : none;" to="/admin/labs">Our Labs</v-tab>
                <v-tab style="text-decoration : none;" to="/admin/enrolls">Manage Enrollment</v-tab>
                <v-tab style="text-decoration : none;" to="/admin/assign">Manage Assign</v-tab>
                <v-tab style="text-decoration : none;" to="/admin/user">Manage User</v-tab>
                <v-tab style="text-decoration : none;" to="/about">About</v-tab>
                <v-tabs-slider color="white"></v-tabs-slider>
            </v-tabs>

            <v-tabs background-color="transparent" v-model="tabs" v-if="type == 'professor'" align-with-title>
                <v-tab style="text-decoration : none;" to="/home">Dashboard</v-tab>
                <v-tab style="text-decoration : none;" to="/professor/labs">Our Labs</v-tab>
                <v-tab style="text-decoration : none;" to="/professor/enrolls">Manage Enrollment</v-tab>
                <v-tab style="text-decoration : none;" to="/professor/assigns">Manage Assign</v-tab>
            ...
            <v-tabs background-color="transparent" v-model="tabs" v-if="type == 'ta'" align-with-title>
                <v-tab style="text-decoration : none;" to="/home">Dashboard</v-tab>
                <v-tab style="text-decoration : none;" to="/ta/labs">Our Labs</v-tab>
                <v-tab style="text-decoration : none;" to="/ta/enrolls">Manage Enrollment</v-tab>
                <v-tab style="text-decoration : none;" to="/about">About</v-tab>
                <v-tabs-slider color="white"></v-tabs-slider>
            </v-tabs>

            <v-tabs background-color="transparent" v-model="tabs" v-if="type == 'student'" align-with-title>
                <v-tab style="text-decoration : none;" to="/home">Dashboard</v-tab>
                <v-tab style="text-decoration : none;" to="/labs">Our Labs</v-tab>
                <v-tab style="text-decoration : none;" to="/about">About</v-tab>
                <v-tabs-slider color="white"></v-tabs-slider>
            </v-tabs>
